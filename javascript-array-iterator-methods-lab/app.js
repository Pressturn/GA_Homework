...
isAdultPresent = devs.some((age) => {
    return (currentYear - age.year) > 18;
});
// Complete the exercise in the space below:
...
// Complete the exercise in the space below:
travelMethodCounts = travelMethods.reduce(( accumulator, travel) => {
if (accumulator[travel]){
    accumulator[travel] = accumulator[travel] +1;
} else {
    accumulator[travel] = 1;
} 
return accumulator;
}, {} );
